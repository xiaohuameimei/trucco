/*
* @Author: Marte
* @Date:   2017-07-06 16:43:10
* @Last Modified by:   Marte
* @Last Modified time: 2017-07-11 17:03:47
*/
var provinceList = [
                    {name:'北京', cityList:[
    ...
    $(function(){
        $(".agree").on("click",function(){
         ...
         $(".selected").on("click",function(){
            ...
            $(".addressList img").attr("src","images/radio2_address.png");
            $($(".addressList")[index]).children("img").attr("src","images/radio1_address.png");

         });

    console.log(provinceList);
    var provinceOption = "<option>请选择省份</option>";
     ...
     var mymessage=confirm("确定要删除吗？") ;
        if(mymessage==true)
        {
             ...
             for(var i = 0 ; i < $(".delete").length ; i++){
                 ...
                 $($(".addressList")[i]).attr("index",i);
                 var length = $("#tbody tr td.selected").length /  $(".delete").length;
                 for(var j = 0 ; j < length ; j++){
                    if(i > 0){
                         var jIndex = j + 4;
                         $($("#tbody tr td.selected")[jIndex]).attr("index",i);
                    }else{
                         $($("#tbody tr td.selected")[j]).attr("index",i);
                    }
                 }
             };
          };
